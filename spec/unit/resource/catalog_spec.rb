...
describe Puppet::Resource::Catalog, "when compiling" do
  ...
  it "should write its resources' types, namevars and source to the resource file" do
    ...
    catalog.add_resource(res, res2)
    catalog.write_resource_file
    File.open(resourcefile).readlines.map(&:chomp).should =~ [
      "file[/tmp/sam] defined in site.pp:21",
      "exec[/bin/rm -rf /] defined in /modules/bob/manifests/bob.pp:42"
    ]
  end
